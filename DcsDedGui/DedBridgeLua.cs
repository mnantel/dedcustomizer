...
/// <summary>
/// The ded_bridge.lua script content, embedded here so the app can deploy it
/// to the user's DCS Saved Games folder without needing a separate file.
/// </summary>
public static class DedBridgeLua
{
